...
export default function ApplicationForm({ show, setShow }) {
  ...
  const handleSend = () => {
    ...
    if (fullname === "" || fullname.length > 50) array.push(1);
    ...
    if (
      ...
      array.push(3);
    if (number === "" || number.length < 7 || number.length > 20) array.push(4);
    if (cv.files.length === 0) array.push(5);
    if (opinion === "" || opinion.length < 10) array.push(6);
    if (!agree) array.push(7);

    if (array.length === 0) setSend(true);
    else setError(array);
  };
  ...
  return (
    <div
      ...
      <div
        className="container"
        style={
          show ? { animationName: "showForm" } : { animationName: "hideForm" }
        }>
        <div className="form" style={send ? { animationName: "sendForm" } : {}}>
          <div className="title" style={send ? { display: "none" } : {}}>
          ...
          <div className="inputs" style={send ? { display: "none" } : {}}>
            <TextField
              ...
              helperText={
                error.includes(1) ? "Wpisz poprawne imię i nazwisko." : " "
              }
              color="success"
              variant="standard"
              size="large"
            ...
            <TextField
              ...
              helperText={
                error.includes(3)
                  ? "Wpisz swój poprawny adres email, w razie pytań będziemy na niego pisać."
                  : " "
              }
              color="success"
              variant="standard"
            ...
            <TextField
              ...
              helperText={
                error.includes(4) ? "Wpisz swój poprawny numer telefonu." : " "
              }
              color="success"
              variant="standard"
              size="large"
            ...
            <TextField
              ...
              helperText={
                error.includes(6)
                  ? "Bez tego, twoje podanie odrzucimy automatycznie."
                  : " "
              }
              color="success"
              variant="standard"
